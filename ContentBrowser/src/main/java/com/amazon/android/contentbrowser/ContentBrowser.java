...
public class ContentBrowser implements IContentBrowser, ICancellableLoad {
    ...
    public static final int CONTENT_ACTION_BUY_25 = 16;
    public static final int CONTENT_ACTION_BUY_100 = 17;
    public static final int CONTENT_ACTION_BUY_500 = 18;
    ...
    public static final List<Integer> PRICE_LIST = Arrays.asList(25, 100, 500);

    public static final Map<String, Integer> PRICE_MAP = createMap();

    private static Map<String, Integer> createMap() {
        Map<String, Integer> result = new HashMap<>();
        result.put("25", R.string.buy_1);
        result.put("100", R.string.buy_2);
        result.put("500", R.string.buy_3);
